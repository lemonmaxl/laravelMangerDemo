            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    ...
                    <div class="tabs-left">
                        ...
                        <form class="form-horizontal" id="addGoodForm" method="post" action="{{url('admin/goods')}}">
                        {{csrf_field()}}
                        <div class="tab-content ">
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
									    ...
									    <div class="form-group">
									        ...
									        <div class="col-sm-9">
									            <input type="text" name="short_title" class="form-control" value="{{old('short_title')}}" placeholder="">
									    ...
									    <div class="form-group">
									        ...
									        <div class="col-sm-9">
									            <input type="text" name="number" class="form-control" value="{{old('number' , time())}}" placeholder="">
									            <span class="help-block m-b-lg"></span>
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-9">
						                        <textarea id="editor" name="detail" placeholder="这里输入内容" autofocus>{{old('detail')}}</textarea>
						                    </div>
										</div>
									</div>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
									    <div class="form-group">
									        ...
									        <div class="col-sm-9">
									            <input type="number" name="markt_price" value="{{old('markt_price' ,0)}}" class="form-control" placeholder="">
									    ...
									    <div class="form-group">
									        ...
									        <div class="col-sm-9">
									            <input type="number" name="shop_price" value="{{old('shop_price' ,0)}}" class="form-control" placeholder="">
									            <span class="help-block m-b-lg" style="color: #888"></span>
									    ...
									    <div class="form-group">
									        ...
									        <div class="col-sm-3">
									            <input type="number" name="sale_price" value="{{old('sale_price')}}" class="form-control" placeholder="">
									            <span class="help-block m-b-lg"></span>
									        </div>
									        <label class="col-sm-1 control-label">促销时间：</label>
	                                        <div class="col-sm-5">
	                                            <input placeholder="开始日期" name="start_time" value="{{old('start_time')}}" class="form-control layer-date" id="start">
	                                            <input placeholder="结束日期" name="end_time" value="{{old('end_time')}}" class="form-control layer-date" id="end">
	                                            <span class="help-block m-b-lg"></span>
	                                        </div>
									    </div>
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="panel-body">
			                        ...
			                        <input type="hidden" name="pic" value="{{old('pic')}}" id="img_pic">
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
									    <div class="form-group">
									        ...
									        <div class="col-sm-9">
									            <input type="text" name="tags" id="tags" value="{{old('tags' , '热卖,新品')}}" class="form-control" />
